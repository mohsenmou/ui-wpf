...
namespace Mohsenmou.UI.WPF
{
    public sealed class Theme
    {
        ...
        public static void LoadThemeType(ThemeType type)
        {
            ...
            switch (type)
            {
                case ThemeType.Light:
                    InitializeLightTheme(Colors.BlueViolet);
                    break;
                case ThemeType.Dark:
                    InitializeDarkTheme(Colors.DarkGray);
                    break;
            }
        }
                                                 ...
                                                 string foregroundColor = "#FF3F3F3F")
        {
            ...
            SetResource(ThemeResourceKey.ControlBorder.ToString(), new SolidColorBrush(ColorHelper.GetColorLighter(accentColor, 0.8)));
            ...
            SetResource(ThemeResourceKey.ControlMouseOverBorder.ToString(), new SolidColorBrush(ColorHelper.GetColorLighter(accentColor, 0.8)));
